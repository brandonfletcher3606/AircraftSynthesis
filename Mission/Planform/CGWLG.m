function CenterOfGravity = CGWLG(cg,LG)
%% INPUTS
...
CenterOfGravity.x.NLG = LG.landingGear.Position.Nose(1);
CenterOfGravity.x.LMLG = LG.landingGear.Position.Main(1);
CenterOfGravity.x.RMLG = LG.landingGear.Position.Main(1);
...
CenterOfGravity.y.NLG = LG.landingGear.Position.Nose;
CenterOfGravity.y.LMLG = LG.landingGear.Position.Main;
CenterOfGravity.y.RMLG = -LG.landingGear.Position.Main;
...
CenterOfGravity.z.NLG = 0;
CenterOfGravity.z.LMLG = 0;
CenterOfGravity.z.RMLG = 0;
...
M_APU_x = APU_x * APU;
M_NLG_x = CenterOfGravity.x.NLG * NLG;
M_LMLG_x = CenterOfGravity.x.LMLG * LMLG;
M_RMLG_x = CenterOfGravity.x.RMLG * RMLG;
...
M_APU_y = APU_y * APU;
M_NLG_y = CenterOfGravity.y.NLG * NLG;
M_LMLG_y = CenterOfGravity.y.LMLG * LMLG;
M_RMLG_y = CenterOfGravity.y.RMLG * RMLG;
...
%% EMPTY WEIGHT
%%
Sum_Moment_X_2 = M_Nacelle1_x +M_Nacelle2_x +M_Wing1_x+M_Wing2_x +M_Fueslage_x +M_Vertical_Tail_x+M_Horizontal_Tail_x +M_Flight_Controls_x+M_Pilot_Seats_x +M_Galley_1_x +M_Laventory_1_x +M_Passengers_Seats_x +M_Laventory_2_x +M_Ecu_x +M_Fire_Proection_x + M_EMER_x + M_APU_x+M_NLG_x+M_LMLG_x+M_RMLG_x; 
Sum_Moment_y_2 = M_Nacelle1_y +M_Nacelle2_y +M_Wing1_y+M_Wing2_y +M_Laventory_1_y  +M_Laventory_2_y + M_Galley_1_y+M_NLG_y+M_LMLG_y+M_RMLG_y;
Sum_Moment_z_2 = M_Nacelle1_z +M_Nacelle2_z +M_Vertical_Tail_z+M_Horizontal_Tail_z +M_Flight_Controls_z +M_Galley_1_z +M_APU_z+M_NLG_z+M_LMLG_z+M_RMLG_z ;
...
Sum_Moment_y_3 = M_Nacelle1_y +M_Nacelle2_y +M_Wing1_y+M_Wing2_y +M_Fuel1_y +M_Fuel2_y +M_Galley_1_y +M_Laventory_1_y  +M_Laventory_2_y+M_NLG_y+M_LMLG_y+M_RMLG_y;
Sum_Moment_z_3 = M_Nacelle1_z +M_Nacelle2_z +M_Vertical_Tail_z+M_Horizontal_Tail_z +M_Flight_Controls_z+M_Galley_1_z + M_APU_z+M_NLG_z+M_LMLG_z+M_RMLG_z ;

CenterOfGravity.CG_X_3 = Sum_Moment_X_3 / OE_Fuel;
CG_Y_3 = Sum_Moment_y_3 / OE_Fuel;
CG_Z_3 = Sum_Moment_z_3 / OE_Fuel;

CenterOfGravity.percentChordOperatingEmptyFuelWeightCG = ((CenterOfGravity.CG_X_3-x_cbar)/(C_bar*12))*100;

%% Operating Empty
%%
Sum_Moment_X_4 = M_Nacelle1_x +M_Nacelle2_x +M_Wing1_x+M_Wing2_x +M_Fueslage_x +M_Vertical_Tail_x+M_Horizontal_Tail_x +M_Flight_Attendant_x +M_Pilots_x  +M_Flight_Controls_x+M_Pilot_Seats_x +M_Galley_1_x +M_Laventory_1_x +M_Passengers_Seats_x +M_Laventory_2_x +M_Ecu_x +M_Fire_Proection_x + M_EMER_x + M_APU_x+M_NLG_x+M_LMLG_x+M_RMLG_x; 
Sum_Moment_y_4 = M_Nacelle1_y +M_Nacelle2_y +M_Wing1_y+M_Wing2_y  +M_Galley_1_y +M_Laventory_1_y  +M_Laventory_2_y+M_NLG_y+M_LMLG_y+M_RMLG_y;
Sum_Moment_z_4 = M_Nacelle1_z +M_Nacelle2_z +M_Vertical_Tail_z+M_Horizontal_Tail_z +M_Flight_Controls_z+M_Galley_1_z + M_APU_z+M_NLG_z+M_LMLG_z+M_RMLG_z ;
...
Sum_Moment_y_5 = M_Nacelle1_y +M_Nacelle2_y +M_Wing1_y+M_Wing2_y +M_Galley_1_y +M_Laventory_1_y +M_Laventory_2_y+M_NLG_y+M_LMLG_y+M_RMLG_y ;
Sum_Moment_z_5 = M_Nacelle1_z +M_Nacelle2_z +M_Vertical_Tail_z+M_Horizontal_Tail_z +M_Flight_Controls_z +M_Galley_1_z +M_APU_z+M_NLG_z+M_LMLG_z+M_RMLG_z ;
